      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between">
        ...
        {!isEditing && (
          <div className="flex flex-col sm:flex-row gap-3 mt-4 sm:mt-0">
            {!budgets.some(b => b.is_master) && (
              <button
                onClick={() => handleAddNew(true)}
                className="flex items-center justify-center gap-2 px-4 py-2 bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-200 rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-all"
              >
              ...
              <div className="glass-card rounded-3xl p-8 overflow-hidden relative border-cyan-500/5 shadow-2xl shadow-black/5">
                ...
                <div className="relative flex flex-col md:flex-row md:items-start md:justify-between mb-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-2 mt-4 md:mt-0">
                    <button onClick={() => handleClone(selectedBudget)} className="flex items-center justify-center gap-2 px-4 py-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl text-sm font-semibold text-slate-600 dark:text-slate-300 hover:shadow-lg transition-all">
                      <Copy className="w-4 h-4" />
                      Clone
                    </button>
                    <button onClick={() => handleEdit(selectedBudget)} className="flex items-center justify-center gap-2 px-4 py-2 bg-cyan-500 text-white rounded-xl shadow-lg shadow-cyan-500/20 hover:bg-cyan-600 transition-all font-semibold text-sm">
